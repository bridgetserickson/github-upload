...
var scores, roundScore, activePlayer, dice, gamePlaying, count, lastRoll, winningScore;
...
document.querySelector('.btn-roll').addEventListener('click', function() {
 if(gamePlaying) {
     ...
     // 2 sixes deletes total score, switch player
     if(thisRoll === 6 && lastRoll === 6 && count === 2) {
         alert('Two sixes! Start back at zero 💩');
         lastRoll= 0;
         count = 0;
    ...
    //next player
    alert('You rolled a 1! Your round score is 0.');
    nextPlayer();
...
function init() {
    ...
    //hide dice when page first opens
